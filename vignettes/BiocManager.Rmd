...
CRAN packages for out-of-date _Bioconductor_ releases are installed
from the [Microsoft _R_ Application Network][MRAN]; see
`?BiocManager.snapshot` to change this behavior.
