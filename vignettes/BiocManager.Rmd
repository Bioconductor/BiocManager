...
The _[Bioconductor][1]_ project aims to provide tools for the analysis and
comprehension of high-throughput genomic data. The project provides access to a
wide range of statistical and graphical methods for the analysis of genomic
data, as well as annotation data for a variety of model organisms. Bioconductor
is open source and open development, and encourages participation from the
wider community.

# Introduction

[BiocManager][2] is the main entry-point for installing and managing
_Bioconductor_ packages. It is a CRAN package that provides a consistent
interface for installing _Bioconductor_ packages, as well as for managing
package versions and dependencies. The package is designed to work with the
latest version of _Bioconductor_, and is compatible with the latest version of
_R_.
...
new release version is created every six months. Using the [BiocManager][2]
...
[BiocManager][2] package. This command is required only once per _R_
installation.
...
[2]: https://cran.r-project.org/package=BiocManager
