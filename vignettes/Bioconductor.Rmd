...
Use the [Bioconductor][1] package to install and manage packages from the
...
new release version is created every six months. Using the [Bioconductor][1]
package helps users install packages from the same release.

# Basic use

Use the standard _R_ installation procedure To install the [Bioconductor][1]
package
